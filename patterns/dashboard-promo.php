		...
		<div class="wp-block-columns dashboard-promo__cards">
			...
			<div class="wp-block-group dashboard-promo__card dashboard-promo__card--hiv has-neutral-100-background-color has-background" style="border-radius:var(--wp--preset--border-radius--400);padding:var(--wp--preset--spacing--40)">
				...
				<div class="wp-block-buttons">
					...
					<div class="wp-block-button has-custom-font-size is-style-secondary has-300-font-size"><a class="wp-block-button__link has-300-font-size has-custom-font-size wp-element-button" href="<?php echo esc_url( home_url( '/hiv-dashboard/' ) ); ?>" style="padding-right:var(--wp--preset--spacing--30);padding-left:var(--wp--preset--spacing--30)"><?php echo esc_html__( 'Open the HIV Dashboard', 'spotlight-theme-2026' ); ?></a></div>
					<!-- /wp:button -->
				</div>
				<!-- /wp:buttons -->
			</div>
			...
			<div class="wp-block-group dashboard-promo__card dashboard-promo__card--tb has-neutral-100-background-color has-background" style="border-radius:var(--wp--preset--border-radius--400);padding:var(--wp--preset--spacing--40)">
				...
				<div class="wp-block-buttons">
					<!-- wp:button {"className":"is-style-secondary","fontSize":"300","style":{"spacing":{"padding":{"left":"var:preset|spacing|30","right":"var:preset|spacing|30"}}}} -->
					<div class="wp-block-button has-custom-font-size is-style-secondary has-300-font-size"><a class="wp-block-button__link has-300-font-size has-custom-font-size wp-element-button" href="<?php echo esc_url( home_url( '/tb-dashboard/' ) ); ?>" style="padding-right:var(--wp--preset--spacing--30);padding-left:var(--wp--preset--spacing--30)"><?php echo esc_html__( 'Open the TB Dashboard', 'spotlight-theme-2026' ); ?></a></div>
					<!-- /wp:button -->
				</div>
				<!-- /wp:buttons -->
			</div>
