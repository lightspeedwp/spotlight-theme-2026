...
<div class="wp-block-group related-coverage-callout has-neutral-200-background-color has-background" style="border-radius:var(--wp--preset--border-radius--200);padding:var(--wp--preset--spacing--20)">
	...
	<h3 class="wp-block-heading has-accent-700-color has-text-color has-400-font-size" style="font-weight:500;line-height:var(--wp--custom--line-height--heading);letter-spacing:0.3px"><?php echo esc_html__( 'More from Spotlight', 'spotlight-theme-2026' ); ?></h3>
	<!-- /wp:heading -->

	<!-- wp:query {"query":{"perPage":5,"postType":"post","order":"desc","orderBy":"date","inherit":false,"excludeCurrent":true,"sticky":"ignore"}} -->
